...
- За новые микросервисы в периметрах АБС/интернет банка - будут отвечать соответственно отдел разработки АБС/отдел IT;
...
- новый функционал ИБ (заявки) написать на микросервисной архитектуре; выбран стек Java, Spring - в том числе исходя из того, что с ним знакома команда IT отдела;  
...
- новый адаптер для обмена файлами с партнерским колл-центром передачи туда новых заявок на депозиты, и возврата статусы "обработана в колл-центре";
