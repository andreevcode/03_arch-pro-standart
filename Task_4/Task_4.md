...
Судя по всему в данном задании необходимо не забыть учесть, что передача ставок в колл-центры должна входить в MVP. Тогда скорректированное описание MVP будет выглядеть так:
- 6 месяцев. MVP по депозитам:
  ...
  - передача депозитных ставок в колл-центры;
...
- За новые микросервисы в периметре АБС - будет отвечать отдел разработки АБС;
...
Я исходил, что нужно сделать roadmap только для кейса передачи ставок в колл-центры (без кейсов из задания 2)
